...
const int frontLeftID = 1, frontRightID = 2, rearLeftID = 3, rearRightID = 4;
...
const frc::MecanumDriveKinematics kinematics(frontLeftPose,
                                             frontRightPose,
                                             rearLeftPose,
                                             rearRightPose);

const rmb::SparkMaxVelocityController<units::meters>::PIDConfig motorPIDConfig{
...
const units::meters_per_second_squared_t maxAcceleration(5_mps_sq);
...
const frc2::PIDController xController(0.0, 0.0, 0.0),
    yController(0.0, 0.0, 0.0);
const frc::ProfiledPIDController<units::radians>
    thetaController(0.0, 0.0, 0.0, {maxRotVelocity, maxRotAcceleration});
} // namespace driveSubsystemConstants
...
const int leftShooterMotorID = 0, rightShooterMotorID = 0;

const rmb::SparkMaxVelocityController<units::radians>::PIDConfig motorPIDConfig{
    /* p */ 0.0, /* i */ 0.0, /* d */ 0.0, /* f */ 0.0,
    /* iZone */ 0.0, /* iMaxAccumulator */ 0.0,
    /* maxOutput */ 1.0, /* minOutput */ -1.0,
...
const rmb::SimpleMotorFeedforward<units::radians> motorFeedforward(
    rmb::SimpleMotorFeedforward<units::radians>::Ks_t(0.10973),
...
const auto motorConversion =
    rmb::SparkMaxVelocityController<units::radians>::ConversionUnit_t(1_rad /
                                                                      1_rad);
